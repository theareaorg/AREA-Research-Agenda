:Title: AREA Research Agenda Documentation
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
This document provides guidance about topics for future research. It is based on insights and opinions of the members of the AR for Enterprise. 
...
include::annex-terms-and-definitions.adoc[]
