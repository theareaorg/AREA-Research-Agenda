...
NOTE: NEEDS MORE WORK and is very close to facial obfuscation [DISAGREE -OP] topic and Tsecurity5-multiusedisplays.adoc [THIS TOPIC INCLUDES TWO LOSELY RELATED SUBJECTS: CLEANING DEVICES AND AUTHENTICATING USERS. PERHAPS FOCUS THIS ON ONLY CLEANING?]
