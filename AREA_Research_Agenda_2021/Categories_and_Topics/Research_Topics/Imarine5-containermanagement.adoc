...
This research topic focuses on documenting use cases for enriching the interactions that AR-enabled technicians, on board and in port, when they receive and can use accurate and up to date container information. With this information as the professionals move about within and around containers when loading, inspecting, maintaining or repairing commercial containers, productivity, security and safety compliance can increase.
