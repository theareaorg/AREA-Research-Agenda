...
////
Foundation concepts are basic concepts which are important for the use of the standard. The contents of this section are referenced from within this Users Guide. Exterior links should not resolve in this section.
////

[[ra-research-agenda-foundations-section]]
== AREA Research Agenda Foundations

include::clause_6_methodology.adoc[]

include::clause_6-1_first_method.adoc[]

include::clause_6-2_second_method.adoc[]
...
include::clause_7_research_topics.adoc[]
