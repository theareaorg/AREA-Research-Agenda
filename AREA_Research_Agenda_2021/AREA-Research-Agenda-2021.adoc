...
|External identifier of this AREA(R) document: http://www.opengis.net/doc/EG/{standard}/{m.n}
|Internal reference number of this AREA(R) document:    YY-nnnrx
|Version: n.n
