...
image:https://github.com/theareaorg/AREA-Research-Agenda/blob/main/AREA_Research_Agenda_2021/figures/overall_methodology.png[alt="not bad.",width=128,height=128]

image::figures/overall_methdology.png[Overview of the methodology]
[#img-methods]
.Methodology
[link=https://github.com/theareaorg/AREA-Research-Agenda/blob/main/AREA_Research_Agenda_2021/figures/overall_methodology.png]
image::figures/overall_methdology.png[Sunset,300,200]
